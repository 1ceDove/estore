...
<body>
		...
		<div class="contentCenter">
			...
			<div class="centerTop">
				...
				<p style="font-size: 15px;">
					收件人姓名：<input type="text" id='addName' disabled name="name"><br />
					<br /> 收件人地址：<input type="text" id='addAdd' disabled name="address"><br />
					<br /> 收件人电话：<input type="text" id='addPhone' disabled name="tel">
				</p>
				<p style="font-size: 15px;">
					<button
			...
			<!-- </form> -->
			<p class="singleP">
				<b>送货清单</b>&nbsp;&nbsp;&nbsp;&nbsp; <span> <%-- <a href="#"><button>删除该订单</button></a>   --%>
			...
			<div class="bigDiv">
				<table border="1px solid red">
					<c:forEach items="${confirms }" var="shopInfo">
						<tr>
							<td width="100px"><img
								src="${shopInfo.img.split('[#]')[0] }" width="100px"
								height="100px"></td>
			...
			<div class="submit">
				<span>应付金额： <font id="allpri">¥${allPrices }</font> <a
					href="javascript:document.forms.conSuccess.submit()"> <img
						alt="" src="images/21_03.png">
				</a> <!-- <button onclick="document.forms.conSuccess.submit()">	
	    				</button> -->
				</span>
			</div>
		</div>
	...
	<div id="divDialog"
		...
		<div class="pop">
			...
			<div class="pop_con">
				<form class="info_list" id="conSuccess"
					action="user/ConfirmSubmitServlet" method="post">
					<%-- <input type="hidden" name="orderNums" value="${orderNums }"> --%>
					<ul>
						<li><span class="name">收货人</span> <input name="username"
							type="text" id="addr_name" value="" maxlength="20"></li>
						<li><span class="name">手机号码</span> <input name="phone"
						...
						<li><span class="name">详细地址</span> <input name="address"
							type="text" style="width: 413px;" id="addr_detail" value=""
							maxlength="150"></li>
