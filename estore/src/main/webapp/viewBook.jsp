...
<script type="text/javascript">
	function addShopCart(productId) {
		...
		if (remain == 0) {
			...
			if (productNum <= 0) {
				alert("加购数量不能小于1件");
			} else if (productNum > remain) {
				alert("加购数量超过库存");
			} else {
				$.ajax({
					url : "user/AddShopCartServlet",
					//给servlet传递商品ID参数，以及数量
					data : "productId=" + productId + "&productNum="
							+ productNum,
	...
	<div class="container5">
		<div class="cn5_top">
			<div class="cn5_top_x center01">
				<a class="font20" href="#">书籍</a> > <a href="#">${productInfo.cate_detail.name}</a>
			</div>
				...
				<div class="cn5topy_1">
					<div class="cn5topy_imgview">
						...
						<ul class="cn5topy_imglist">
							<li><a href="#"><img
									src="${productInfo.img.split('[#]')[1] }"></a></li>
				...
				<div class="cn5topy_2">
					...
					<div class="pro_price">
						<div class="pro_price_x">
							<p>
								briup价：<b>￥${productInfo.price }</b> <a href="#">(降价通知)</a>
							</p>
						</div>
					...
					<div class="pro_buy">
						...
						<div class="pro_addshop">
							<a href="javascript:void(0)"
								onclick="addShopCart('${productInfo.id}')">加入购物车 </a>
						</div>
					</div>
		...
		<div class="c5_b2">
			...
			<div class="c5_b2_right">
				<div class="c5_b2_right_2">
					<h1>正品行货</h1>
					<p>网上商城向您保证所售商品均为正品，briup自营商品开具机打发票或电子发票。</p>

					<h1>全国联保</h1>
					<p>凭质保证书及briup网上商城发票，可享受全国联保服务，与您亲临商场选购的商品享受相同的质量保证。网上商城还为您提供具有竞争力的商品价格和运费政策，请您放心购买！</p>
